...
(function() {
    ...
    // Geser command ke kanan layar (ala Neptunia)
    var w = this._actorCommandWindow;
    w.x = Graphics.boxWidth - w.width - 40; // kanan layar
    w.y = 220; // tinggi sedang, bisa kamu ubah
};
